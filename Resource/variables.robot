...
#    CONTEUDO
&{URL}                    main=https://developer.clashroyale.com/        login=https://developer.clashroyale.com/#/login        key=https://developer.clashroyale.com/#/new-key
&{USER}                   nome=Bruno mendonça        email=brunomendonca011@gmail.com        password=Theo2020!
&{KEY}                    nome=BrunoKey        desc=Descrição        ip=187.11.121.221
